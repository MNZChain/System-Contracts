...
- epoch. Time interval in blocks, currently 1epoch = 100block on `MainnetZ`. At the end of each epoch, the blockchain interacts with the system contracts to update active validators.
